...
from espn_scraper.items import NFL_TE_Game_2015
...
class EspnSpider(Spider):
    ...
    start_urls = ['http://espn.go.com/nfl/player/gamelog/_/id/13229/rob-gronkowski',
                  'http://espn.go.com/nfl/player/gamelog/_/id/15788/tyler-eifert',
                  ]
    ...
    def parse(self, response):
        ...
        for game_row in games_table:
            ...
            loader = ItemLoader(item=NFL_TE_Game_2015(), response=response)
